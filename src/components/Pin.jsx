						...
						<div className="flex items-center justify-between">
							<div className="flex gap-2">
								<a
									...
									className="bg-white p-2 rounded-full flex items-center justify-center text-dark text-xl opacity-75 hover:opacity-100 hover:shadow-md"
								>
							...
							{alreadySaved ? (
								...
								<button type="button" onClick={e => {
									e.stopPropagation();
									savePin(_id);
								}} className="bg-red-500 opacity-70 hover:opacity-100 text-white font-bold px-5 py-1 text-base rounded-3xl hover:shadow-md outline-none">{savingPost ? 'Saving...' : 'Save'}</button>
							)}
						</div>
